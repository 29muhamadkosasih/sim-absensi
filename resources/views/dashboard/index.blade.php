        ...
        <div class="row match-height">
            ...
            <div class="col-xl-4 col-md-6 col-12">
                <div class="card card-congratulation-medal">
                    <div class="card-body">
                        <h5>Congratulations {{ $artikels }} !</h5>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <p class="card-text font-small-3 mb-0">Total Report</p>
                                        <h4 class="fw-bolder mb-0">{{ $totalreport }}</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <h4 class="fw-bolder mb-0">{{ $hadir }}</h4>
                                    </div>
                                </div>
                            </div>
