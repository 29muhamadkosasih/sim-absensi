...
<div class="row">
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body pt-2">
                @if (isset($edit))
                @include('page.rayon.edit')
                @else
                {{ url('/login') }}
                @include('page.rayon.create')
                @endif
            </div>
        </div>
    </div>
    <div class="col-xs-8 col-sm-8 col-md-8">
        <div class="card">
            ...
            <div class="card-header border-bottom p-1">
                <div class="head-label">
                    <h4 class="card-title">List Data Rayon</h4>
                </div>
            </div>
            {{-- body --}}
                ...
                <table class="table table-bordered dataTable zero-configuration">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">{{ $data->pembimbing }}</td>
                            <td class="text-center">
                                <form onsubmit="return confirm('Apakah Anda Yakin ?');"
                                    action="{{ route('rayon.destroy', $data->id) }}" method="POST">
                                    <a href="{{ route('rayon.edit', $data->id) }}" class="btn btn-primary btn-sm">
